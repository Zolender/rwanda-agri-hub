    ...
    return (
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            ...
            <form onSubmit={handleSale} className="space-y-4">
                ...
                className="w-full p-3 text-slate-700 bg-slate-50 rounded-xl border-none focus:ring-2 focus:ring-emerald-500"
                />
                ...
                className="w-full p-3 text-slate-700 bg-slate-50 rounded-xl border-none"
                />
